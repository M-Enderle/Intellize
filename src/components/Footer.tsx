        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          ...
          <div>
             ...
             <div className="flex space-x-4">
               <a href="https://github.com/M-Enderle" target="_blank" rel="noopener noreferrer" className="text-gray-600 hover:text-black transition-colors" aria-label="GitHub Profile">
                 <Github size={20} />
               </a>
               <a href="https://www.linkedin.com/in/moritz-enderle/" target="_blank" rel="noopener noreferrer" className="text-gray-600 hover:text-black transition-colors" aria-label="LinkedIn Profile">
                 <Linkedin size={20} />
               </a>
               <a href="mailto:info@intellize.de" className="text-gray-600 hover:text-black transition-colors" aria-label="Email Contact">
                 <Mail size={20} />
               </a>
             </div>
          </div>
